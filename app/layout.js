  ...
  useEffect(() => {
    const updateHeaderHeight = () => {
      if (headerRef.current) {
        ...
        console.log("Header Height:", headerRect.height); // Debugging: log the header's height
  ...
  return (
    <html lang="en">
     <head>
            ...
            <link href="https://fonts.googleapis.com/css2?family=Hind+Madurai:wght@400;500;600;700&family=Lora:wght@400..700&family=Montserrat:wght@100..900&display=swap" rel="stylesheet" />
      </head>
      <body>
